...
const benefits = [
  {
    ...
    description: "Stay updated on industry trends and how to adopt them effectively.",
  },
  {
    icon: "/icons/computer.gif",
    title: "CPD and Training",
    description:
      "Access to relevant CPD programs and Training sessions.",
  },
  {
    icon: "/icons/writing_book.gif",
    title: "Platform to share your achievements and inspire others",
    description: "Allows members to showcase their success, motivate peers, and encourage positive action within the community.",
  },
  {
    icon: "/icons/support.gif",
    title: "Expert Advice",
    description: "Benefit from experienced professionals' support and knowledge.",
  },
  {
...
export default function MemberBenefitsPage() {
  return (
    <main className="w-full bg-white py-12 px-6 sm:px-8 md:px-19  lg:px-16 xl:px-15 2xl:px-5  max-w-screen-xl mx-auto border-b  rounded-md">
      <div className="mb-10">
        <h1 className="text-sm sm:text-base font-semibold text-gray-500 tracking-widest uppercase mb-2">
          Member Benefits
        </h1>
        ...
        <p className="text-base sm:text-lg text-gray-700 mb-4">
         Membership with the Professional Accountants’ Society gives you access to a growing network of British Bangladeshi finance professionals across the UK. Whether you&apos;re newly qualified, mid-career, or an industry expert, you&apos;ll find value in joining our community.
        </p>
