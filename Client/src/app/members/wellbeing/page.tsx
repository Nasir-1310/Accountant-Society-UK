...
import { Brain, Handshake, Scale } from "lucide-react";
    ...
    <Container>
      ...
      <section className="bg-gradient-to-r from-blue-100 to-blue-200 py-16 px-4 mx-3 text-center ">
        ...
        <p className="text-lg text-black mb-6 max-w-2xl mx-auto">
          Your trusted resource for fostering mental health and resilience
      ...
      <section className="text-center py-16 px-4">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto text-base sm:text-lg mb-6">
          In the demanding landscape of accounting, prioritising your wellbeing
          isn’t optional – it’s essential. At TPAS Wellbeing, we are committed
          to supporting our members through a range of tools, expert insights,
          and practical guidance designed specifically for the profession.
        </p>
        <Rounded_Button>
      ...
      <section className="py-16 bg-gray-50 px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">
              A safe space to connect, share, and grow with like-minded
              professionals.
            </p>
          </div>
        </div>
