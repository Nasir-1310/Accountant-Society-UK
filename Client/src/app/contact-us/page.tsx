          ...
          <div className="w-full lg:w-3/4 order-1 lg:order-2 px-6 lg:px-10 py-8">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Get in touch with The Professional Accountants Society
              </p>
            </div>
            ...
            <div className="space-y-8 mb-10">
              ...
              <section>
                <h2
                  data-aos="fade-up"
                  className="text-2xl font-bold text-teal-700 mb-6 flex items-center gap-2"
                >
                    ...
                    <div data-aos="fade-up" className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          <a
                            href="tel:07988834395"
                            className="text-black hover:text-teal-500 transition-colors"
                          >
                            07988 834395
                          </a>
                        </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div data-aos="fade-up">
                      ...
                      >
                        ...
                        <option value="Membership Enquiry">
                          Membership Enquiry
                        </option>
                        <option value="General Information">
                          General Information
                        </option>
                        <option value="Events & Networking">
                          Events & Networking
                        </option>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mb-3">
                    The Professional Accountants’ Society is a vibrant network
                    of British Bangladeshi Chartered Accountants dedicated to
                    collaboration, professional growth, and community impact. We
                    aim to support members through shared knowledge, networking
                    opportunities, and initiatives that inspire excellence in
