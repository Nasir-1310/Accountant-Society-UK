          ...
          <div className="w-full lg:w-3/4 order-1 lg:order-2 px-6 lg:px-10 py-8">
            ...
            <div data-aos="fade-up" className="space-y-8 mb-10">
              ...
              <section data-aos="fade-up" id="vision">
                ...
                >
                  To build a thriving, collaborative community that celebrates
                  and connects the excellence of British Bangladeshi Chartered
                  Accountants, empowering them to lead, inspire, and shape the
              ...
              <section data-aos="fade-up" id="mission">
                ...
                <div className="space-y-3 text-gray-700 leading-relaxed">
                  <p className="flex items-start gap-2">
                    ...
                    To foster a strong network of British Bangladeshi Chartered
                    Accountants in UK.
                  </p>
                  <p className="flex items-start gap-2">
                    <span
                    ...
                    To promote professional development, mentorship, and mutual
                    support.
                  </p>
                  <p className="flex items-start gap-2">
                    <span
                    ...
                    To highlight the achievements and contributions of our
                  ...
                  <p className="flex items-start gap-2">
                    ...
                    To act as a bridge between generations of finance
                    professionals, encouraging innovation, diversity, and
              ...
              <section data-aos="fade-up" id="who-we-are">
                ...
                <p data-aos="fade-up" className="text-gray-700 leading-relaxed">
                  The <strong>Professional Accountants&apos; Society</strong> is
                  a platform formed by and for British Bangladeshi Chartered
                  Accountants and finance professionals. We are a collective of
                  individuals who share a commitment to professional excellence,
                  ethical leadership, and community upliftment. Our members come
                  from a wide range of industries — public practice, corporate
                  finance, public sector, academia, and entrepreneurship —
                  united by a shared heritage and a passion for financial
                  stewardship.
                </p>
              </section>
                ...
                <div className="space-y-4 text-gray-700">
                  <div>
                    ...
                    <p data-aos="fade-up" className="leading-relaxed">
                      We organise professional meet-ups, seminars, and virtual
                      forums to create opportunities for meaningful connections
                      and collaborations.
                    </p>
                  </div>
                  <div>
                    ...
                    <p data-aos="fade-up" className="leading-relaxed">
                      Through structured mentorship programs, we support young
                      professionals and students on their path to qualification
                      and career success.
                    </p>
                  </div>
                  <div>
                    ...
                    <p data-aos="fade-up" className="leading-relaxed">
                      We spotlight the success stories and impact of British
                      Bangladeshi accountants to inspire the next generation and
                      elevate our collective voice in the profession.
                    </p>
                  </div>
                  <div>
                    <h3
                    ...
                    <p data-aos="fade-up" className="leading-relaxed">
                      ...
                      encouraging our members to give back to the community and
              ...
              <section data-aos="fade-up" id="why-we-exist">
                <h2
                  data-aos="fade-up"
                  className="text-2xl font-bold text-teal-700 mb-4 flex items-center gap-2"
                >
                  <Heart className="text-teal-600 w-6 h-6" />
                  Why We Exist
                </h2>
                <p data-aos="fade-up" className="text-gray-700 leading-relaxed">
                  Despite growing numbers of British Bangladeshi professionals
                  in the accounting field, there has long been a gap in
                  representation, recognition, and structured support. This
                  society aims to fill that gap — to connect, uplift, and
                  showcase the immense talent within our community, and to
                  ensure that our voices are heard at every level of the
                  profession.
                </p>
              </section>
            </div>
            ...
            >
              ...
              <div
                data-aos="fade-up"
                className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col"
              >
                ...
                >
                  Access exclusive training programs, workshops, and
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed flex-1 mb-4">
                  Join our regular meetups, conferences, and social gatherings
