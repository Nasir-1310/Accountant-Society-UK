    ...
    <Container>
      <div className="relative h-[90vh] mx-3 overflow-hidden  shadow-lg bg-black mb-4">
        ...
        <div className="absolute inset-0 z-40 flex flex-col items-center justify-center text-center text-white px-4 md:px-8">
          <h1 className="text-2xl  md:text-4xl xl:text-5xl font-bold mb-4 leading-tight max-w-5xl">
          ...
          <p className="text-sm md:text-base text-white max-w-3xl mb-5 md:mb-8 leading-relaxed hidden md:block">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
            <Rounded_Button href="/members/membership-and-fees" className="bg-transparent border-white text-white hover:text-[#0b0b5b]">
              Membership & Fees
            </Rounded_Button>
