    ...
    return (
      <Container>
        <div className="bg-white w-full py-0">
          <div className="h-full px-3 mx-auto w-full max-w-full">
            <div className="w-full flex flex-col-reverse lg:flex-row bg-white shadow-lg overflow-hidden relative min-h-[280px] sm:min-h-[320px] md:min-h-[350px] lg:min-h-[350px] xl:min-h-[350px]">
  ...
  if (slides.length === 0) {
    return (
      <Container>
        <div className="bg-white w-full py-0">
          <div className="h-full px-3 mx-auto w-full max-w-full">
            <div className="w-full flex items-center justify-center bg-gray-100 shadow-lg overflow-hidden relative min-h-[280px] sm:min-h-[320px] md:min-h-[350px]">
        ...
        <div className="h-full px-3 mx-auto w-full max-w-full">
          <div className="w-full group flex flex-col-reverse lg:flex-row bg-white shadow-lg overflow-hidden relative min-h-[280px] sm:min-h-[320px] md:min-h-[350px] lg:min-h-[350px] xl:min-h-[350px]">
            ...
            <div className="w-full lg:w-2/5 px-3 sm:px-4 md:px-6 py-4 sm:py-6 flex bg-gray-200 flex-col justify-center relative order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-700 mb-2 sm:mb-3 leading-tight break-words hyphens-auto">
              ...
              <Link 
                ...
                className="border border-green-500 bg-white text-green-600 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 rounded hover:bg-green-400 hover:border-green-600 hover:text-white transition w-fit text-sm font-medium whitespace-nowrap"
              >
                Read more
              </Link>
...
//   //   description: "British Bangladeshi Accountants Day 2025",
//   //   img: "/slide_show_images/slide_show_01.jpg",
//   //   url: "",
...
//   //   title: "Title sponsor",
//   //   description: "",
//   //   img: "/slide_show_images/slide_show_02.jpg",
//   //   url: "https://bhardwaj.co.uk/personal-insolvency/",
//   //   dotColor: "bg-purple-500",
//   // },
//   // {
//   //   id: 3,
//   //   title: "Lead Sponsor",
//   //   description: "",
//   //   img: "/slide_show_images/slide_show_03.jpg",
...
//   //   title: " Prime Sponsor",
//   //   description: "",
//   //   img: "/slide_show_images/slide_show_04.jpg",
//   //   url: "https://www.tide.co/business-current-account/?",
//   //   dotColor: "bg-purple-500",
//   // },
//    {
//     id: 1,
