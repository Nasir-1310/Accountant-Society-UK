  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-50">
        {/* Main Drawer */}
        <div
          className={`fixed top-20 left-0 w-full sm:w-80 h-[700px] bg-white shadow-xl z-30 transform transition-transform duration-300 ease-in-out ${
            open && expandedMenu === null ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          {/* Static Menu */}
          <div className="flex flex-col px-6 space-y-4 py-10 pb-5">
            <div className="flex items-center gap-3" onClick={handleMainMenuClose}>
        ...
        {/* Submenu Drawer (also from left) */}
        <div
          className={`fixed top-20 left-0 w-full sm:w-80 h-[700px] bg-white shadow-xl z-40 transform transition-transform duration-300 ease-in-out ${
            expandedMenu !== null ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          {expandedMenu !== null && (
            <>
